...
import (
	...
	"github.com/Kami0rn/golang-blockchain/network"
)
...
func (cli *CommandLine) printUsage() {
	...
	fmt.Println(" reindexutxo - startnode -miner ADDRESS - Start a node with ID specified in NODE_ID env. var. -miner enables mining")
...
func(cli *CommandLine) StartNode(nodeID, minerAddress string){
	...
	if len(minerAddress) > 0 {
		if wallet.ValidateAddress(minerAddress){
			fmt.Println("Mining is on. Address to recuive reward: ", minerAddress)
		} else {
